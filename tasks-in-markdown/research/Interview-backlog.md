## [Map Stories to WCAG](https://julianbrooks.github.io/comp2850-hci-publish/wk06/wk6-lab2-needs-consent-backlog.html#step-3-map-stories-to-wcag)


| Story                | WCAG Criterion | Level |
| -------------------- | -------------- | ----- |
| S2 (contrast)        | V1 1.4.3       | AA    |
| S3 (keyboard access) | K1 2.1.1       | A     |
| S4 (resize)          | V2 1.4.4       | AA    |

## [Activity 4: Build Inclusive Backlog](https://julianbrooks.github.io/comp2850-hci-publish/wk06/wk6-lab2-needs-consent-backlog.html#activity-4-build-inclusive-backlog)
